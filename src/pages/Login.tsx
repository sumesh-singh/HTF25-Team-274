            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                {!isLogin && (
                    <div className="relative pt-4">
                        ...
                        />
                        <label className="pointer-events-none absolute left-10 top-1/2 -translate-y-1/2 text-base text-muted-dark transition-all duration-300 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-[1.6rem] peer-focus:scale-75 peer-focus:text-secondary" htmlFor="name">Full Name</label>
                ...
                {isLogin && (
                    <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center">
                            ...
                            />
                            <label htmlFor="remember" className="ml-2 block text-sm text-muted-dark">
                                Remember me
                            </label>
                        </div>
                        <button type="button" onClick={() => navigate('/forgot-password')} className="text-sm font-medium text-secondary hover:text-primary-hover hover:underline">Forgot Password?</button>
                    </div>                )}
                <button 
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
                ...
                >
                    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M12.24 24.0008C15.4764 24.0008 18.2058 22.9382 20.1944 21.1039L16.3274 18.1055C15.2516 18.8375 13.8626 19.252 12.24 19.252C9.0362 19.252 6.3106 17.1399 5.3646 14.3003H1.3916V17.3912C3.37 21.4434 7.4898 24.0008 12.24 24.0008Z" fill="#34A853"/>
                        <path d="M5.36451 14.3003C4.85051 12.8099 4.85051 11.1961 5.36451 9.70575V6.61481H1.39157C-0.465869 10.0056 -0.465869 14.0004 1.39157 17.3912L5.36451 14.3003Z" fill="#FBBC04"/>
                        <path d="M12.24 4.74966C13.9508 4.7232 15.6043 5.36697 16.8433 6.54867L20.2694 3.12262C18.0991 1.0855 15.2197 -0.034466 12.24 0.000808666C7.4898 0.000808666 3.37 2.55822 1.3916 6.61481L5.3644 9.70575C6.3104 6.86173 9.0361 4.74966 12.24 4.74966Z" fill="#EA4335"/>
                    </svg>
